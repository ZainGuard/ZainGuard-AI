...
class IncidentResponseAgent(BaseAgent):
    ...
    def __init__(
        ...
        self.register_tool(
            "create_incident_ticket", self.jira_manager.create_incident_ticket
        )
    ...
    async def _respond_to_incident(
        ...
        try:
            ...
            ticket_key = await self._create_incident_ticket(
                incident_data, analysis, response_actions
            )
    ...
    async def _analyze_incident(self, incident_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # Fallback analysis
                analysis = self._basic_incident_analysis(
                    incident_data, context, threat_data
                )
        ...
        try:
            ...
            if incident_data.get("source_ip"):
                alerts = await self.siem_connector.search_logs(
                    f"src_ip:{incident_data['source_ip']}", limit=10
                )
    ...
    async def _gather_threat_intelligence(
        ...
        try:
            ...
            if incident_data.get("destination_ip"):
                threat_data["destination_ip"] = (
                    await self.threat_intel.check_ip_reputation(
    ...
    async def _determine_response_strategy(
        ...
        strategy = {
            ...
            "estimated_duration": self._estimate_response_duration(
    ...
    async def _execute_response_actions(
        self, incident_id: str, strategy: Dict[str, Any], analysis: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
...
"""
    ...
    async def _malware_playbook(
        self, incident_id: str, analysis: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    async def _data_breach_playbook(
        self, incident_id: str, analysis: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    async def _insider_threat_playbook(
        self, incident_id: str, analysis: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
