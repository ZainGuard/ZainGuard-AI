...
async def health_check() -> Dict[str, Any]:
    ...
    return {"status": "healthy", "service": "ZainGuard AI Platform", "version": "0.1.0"}
...
async def agents_health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Agent health check failed: {str(e)}"
        )
...
async def get_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "tasks": {"total_active": total_tasks},
